#!/usr/bin/env bash
# Release hhm_rpp_siemens: mirror THIS working tree to /opt/apps/<APP_NAME>,
# apply the #RELEASE: .env overrides, stamp the released commit, install deps
# as svc. Fleet paradigm — adapted from data_acquisition's build-release.sh
...
# .log/.txt exists (verified via git ls-files 2026-08-25), and '*-log.*.json'
